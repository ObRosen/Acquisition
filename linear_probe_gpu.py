...
if __name__ == '__main__':
    ...
    concept_list = [mobility, mobility_diff, frontier, frontier_diff,
                    steady, steady_diff, corner, corner_diff, score_f1, score]
    ...
    for concept in concept_list:
        ...
        accuracy_step, accuracy_step_0 = compute_results(
